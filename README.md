# Revit Family to Three.js Converter
...
5. For each selected Family Type:
...
3. Switch the Family Type in the Family Editor, export again, and verify changes in geometry and values.
